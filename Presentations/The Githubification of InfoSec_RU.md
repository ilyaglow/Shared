...
*На пути к открытой, независимой и вовлекающей к участию модели, которая ускоряет накопление знаний в сфере информационной безопасности.*
...
Совместная работа сообщества может ускорить обучение специалистов по защите информации. Знания об атаках, курируемые MITRE ATT&CK, правила обнаружения угроз, выраженные в языке Sigma, и повторимый анализ, описанный в Jupyter notebooks, образуют упорядоченный набор практик. Они объединяют знание, аналитику и анализ.

Если бы организации делились с сообществом своим уникальным опытом, а также опирались на аналогичный опыт коллег, используя вышеперечисленные инструменты, то все специалисты в итоге могли бы воспользоваться лучшими практиками в защите информации.
